...
get_header(); ?>
	...
	?>
		...
		<?php if ( have_posts() ) : ?>
			...
			<ul class="campaign_archive <?php echo esc_attr( get_query_var( 'taxonomy' ) ) ?> campaign_column_<?php echo esc_attr( DN_Settings::instance()->donate->get( 'archive_column', '4' ) ) ?>">
			...
			<?php
				 ...
				 */
				do_action( 'campaign_after_tax_loop' );
			?>

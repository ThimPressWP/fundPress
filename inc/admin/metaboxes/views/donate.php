...
<div class="cmb2-wrap">
	<div class="cmb-field-list">
		...
		<div class="donate_section_type <?php echo $this->get_field_name( 'type' ) === 'campaign' ? '' : 'hide-if-js' ?>" id="section_campaign">
			<!-- hide-if-js -->
		...
		<div class="donate_section_type <?php echo $this->get_field_name( 'type' ) === 'sytem' ? '' : 'hide-if-js' ?>" id="section_system">
			<div class="cmb-row">
				<div class="cmb-th">

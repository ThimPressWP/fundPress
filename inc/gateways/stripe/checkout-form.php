...
<div id="donate-stripe-form">
    ...
    <div class="donate_field">
        ...
        <input name="stripe[cc-number]" id="cc-number" type="tel" class="required cc-number" autocomplete="cc-number" placeholder="•••• •••• •••• ••••" />
    </div>

    <div class="donate_field">
        <label for="cc-exp" class="label-field"><?php _e( 'Expires (MM / YY)', 'tp-donate' ) ?></label>
        <input name="stripe[cc-exp]" id="cc-exp" type="tel" class="required cc-exp" autocomplete="cc-exp" placeholder="•• / ••" />
    </div>
    
    <div class="donate_field">
        <label for="cc-cvc" class="label-field"><?php _e( 'Card Code (CVC)', 'tp-donate' ) ?></label>
        <input name="stripe[cc-cvc]" id="cc-cvc" type="tel" class="required cc-cvc" autocomplete="off" placeholder="•••" />
    </div>
